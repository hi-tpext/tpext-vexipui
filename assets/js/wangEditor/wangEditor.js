...
Editor.prototype = {
    ...
    _initDom: function _initDom() {
        ...
        if (textSelector == null) {
            ...
            // 自行创建的，需要配置默认的样式
            $toolbarElem.css('background-color', '#fcfdfe').css('border', '1px solid #f1f1f1');
            $textContainerElem.css('border', '1px solid #f1f1f1').css('border-top', 'none').css('height', '300px');
        } else {
